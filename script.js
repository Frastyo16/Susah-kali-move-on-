document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "Bersamamu kita akan taklukan dunia" },
        { time: 6, text: "Arungi samudra penuh rintangan" },
        { time: 12, text: "Bersamamu kita akan jalani semua" },
        { time: 12, text: "Memberikan warna yang bisa menjadikan indah" },
        { time: 18, text: "Jangan takut untuk melangkah bersamaku" },
        { time: 26, text: "Bersamamu ku akan dicintai dengan tulus" },
        { time: 32, text: "Tanpa ragu ku akan memberikan cintaku" },
        { time: 39, text: "Bersamaku kamu tak akan sendu" },
        { time: 44, text: "Yakinkan kamu aku yang terbaik untukmu " },
        { time: 53, text: "du du du" },
        { time: 55, text: "....." },
    ];
